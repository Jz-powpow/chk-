...
//====ANTISPAM AND WRONG FORMAT====//
    if (strlen($message) <= 4) {
            sendMessage($chatId, '<b>• 𝘍𝘰𝘳𝘮𝘢𝘵𝘰 𝘪𝘯𝘤𝘰𝘳𝘳𝘦𝘤𝘵𝘰! ⚠️</b>%0A• 𝘜𝘚𝘖 <code>/pp cc|mm|yy|cvv</code>%0A• 𝘎𝘢𝘵𝘦𝘸𝘢𝘺 <code>PayPal Charge 1 USD</code>', $message_id);
            exit();
  }
$r = "0";
...
curl_setopt($ch, CURLOPT_URL, 'https://api.stripe.com/v1/payment_pages/cs_test_a1JeMKD4FloolUYMsEKVB9DuDMIMb8mtAp5NxxgKo4OwgSxo4MYO07zbnr/confirm');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, "eid=NA&payment_method=pm_1OTfcAK258Vuxm4DF5TozVu2&expected_amount=2000&last_displayed_line_item_group_details^[subtotal^]=2000&last_displayed_line_item_group_details^[total_exclusive_tax^]=0&last_displayed_line_item_group_details^[total_inclusive_tax^]=0&last_displayed_line_item_group_details^[total_discount_amount^]=0&last_displayed_line_item_group_details^[shipping_rate_amount^]=0&expected_payment_method_type=card&guid=119a750e-9494-4efe-b137-e7a49987e99393b097&muid=59b16a5d-3c83-4d82-bbb1-20b052c00875927443&sid=3b27b705-ce59-480a-9e3f-4493589966de49c291&key=pk_test_51K1yvAK258Vuxm4DefLCmuJHyQole8qXDOAXoeOFlGAvvGeFwYlkeMutePA37wn4qcO7io15Zrs0KjD1m5qZiVtN00v35dmhXA&version=5816dc8686&init_checksum=wvJj8ytkNXo5f1ipOXbDNe23wzHQWORI&js_checksum=qto~d^%^5En0^%^3DQU^%^3Eazbu^%^5DV^%^60bYx^%^5DP^%^3F^%^3EXO^%^3C_nS^%^3CzX^%^60QOXQQ^%^7Cq^%^3CY^%^23Y^%^25o^%^3FU^%^5E^%^60w&rv_timestamp=qto^%^3En^%^3CQ^%^3DU^%^26CyY^%^26^%^60^%^3EYtr^%^3BY^%^25r^%^3EY^%^25^%^60^%^3EY_C^%^24X^%^26C^%^3D^%^5B^%^5E^%^60^!Y_^%^5C^%^3CY^%^5En^%^7BU^%^3Eo^%^26U^%^26CyXO^%^3B^%^3BX^%^3DQx^%^5B_XDX^%^26UuY^%^3DX^%^25X^%^26n^%^25X^%^26Ms^%^5B_nDX_n^%^24XO^%^5DrYOQveRn^%^24exn^%^26^%^5B^%^5En^%^7BU^%^3Ee^%^26U^%^26Cy^%^5BboyYuPCYbov^%^5BOT^%^3DY^%^26^%^3CyXx^%^5DsYbL^%^24Yu^%^60^%^3DXbL^%^3EX_d^%^23d^%^26YveOQuY_T^%^3Dd^%^26nDYRQveO^%^3CrX^%^26^%^3B^%^26d^%^3DP^%^3CXO^%^23^%^3BX^%^26^%^23DYbMxYNo^%^3FU^%^5E^%^60w");
